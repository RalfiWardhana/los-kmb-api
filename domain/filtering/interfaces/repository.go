...
type Repository interface {
	DummyData(query string) (data entity.DummyColumn, err error)
	DummyDataPbk(query string) (data entity.DummyPBK, err error)
	DataProfessionGroup(query string) (data entity.ProfessionGroup, err error)
	DataGetMappingDp(query string) (data []entity.RangeBranchDp, err error)
