...
func TestFilteringPefindo(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "TEST_REJECT_FilteringPefindo_BPKBNamaSama_ClusterEF_BakiDebet3-20jt_ResultPefindoPass_NotOvd0&10",
			req: request.FilteringRequest{
				Data: request.Data{
					BPKBName:          "K",
					ProspectID:        "SAL02400020230727002",
		...
		{
			name: "TEST_PASS_FilteringPefindo_BPKBNamaSama_ClusterEF_BakiDebet3-20jt_ResultPefindoPass_Ovd0&10",
			req: request.FilteringRequest{
				Data: request.Data{
					BPKBName:          "K",
					ProspectID:        "SAL02400020230727002",
