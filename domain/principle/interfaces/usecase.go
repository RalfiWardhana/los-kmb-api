...
type Usecase interface {
	...
	GetLTV(ctx context.Context, mappingElaborateLTV []entity.MappingElaborateLTV, prospectID, resultPefindo, bpkbName, manufactureYear string, tenor int, bakiDebet float64, isSimulasi bool, pbkScore, customerStatus, gradeBranch string) (ltv int, adjustTenor bool, err error)
