...
// GetLTV provides a mock function with given fields: ctx, mappingElaborateLTV, prospectID, resultPefindo, bpkbName, manufactureYear, tenor, bakiDebet, isSimulasi, pbkScore, customerStatus
func (_m *Usecase) GetLTV(ctx context.Context, mappingElaborateLTV []entity.MappingElaborateLTV, prospectID string, resultPefindo string, bpkbName string, manufactureYear string, tenor int, bakiDebet float64, isSimulasi bool, pbkScore string, customerStatus string) (int, bool, error) {
	ret := _m.Called(ctx, mappingElaborateLTV, prospectID, resultPefindo, bpkbName, manufactureYear, tenor, bakiDebet, isSimulasi, pbkScore, customerStatus)
	...
	var r1 bool
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, []entity.MappingElaborateLTV, string, string, string, string, int, float64, bool, string, string) (int, bool, error)); ok {
		return rf(ctx, mappingElaborateLTV, prospectID, resultPefindo, bpkbName, manufactureYear, tenor, bakiDebet, isSimulasi, pbkScore, customerStatus)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []entity.MappingElaborateLTV, string, string, string, string, int, float64, bool, string, string) int); ok {
		r0 = rf(ctx, mappingElaborateLTV, prospectID, resultPefindo, bpkbName, manufactureYear, tenor, bakiDebet, isSimulasi, pbkScore, customerStatus)
	} else {
		r0 = ret.Get(0).(int)
	}

	if rf, ok := ret.Get(1).(func(context.Context, []entity.MappingElaborateLTV, string, string, string, string, int, float64, bool, string, string) bool); ok {
		r1 = rf(ctx, mappingElaborateLTV, prospectID, resultPefindo, bpkbName, manufactureYear, tenor, bakiDebet, isSimulasi, pbkScore, customerStatus)
	} else {
		r1 = ret.Get(1).(bool)
	}

	if rf, ok := ret.Get(2).(func(context.Context, []entity.MappingElaborateLTV, string, string, string, string, int, float64, bool, string, string) error); ok {
		r2 = rf(ctx, mappingElaborateLTV, prospectID, resultPefindo, bpkbName, manufactureYear, tenor, bakiDebet, isSimulasi, pbkScore, customerStatus)
	} else {
		r2 = ret.Error(2)
	}
...
// History2Wilen provides a mock function with given fields: req
func (_m *Usecase) History2Wilen(req request.History2Wilen) ([]response.History2Wilen, error) {
	ret := _m.Called(req)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(request.History2Wilen) ([]response.History2Wilen, error)); ok {
		return rf(req)
	}
	if rf, ok := ret.Get(0).(func(request.History2Wilen) []response.History2Wilen); ok {
		r0 = rf(req)
	} else {
		if ret.Get(0) != nil {
