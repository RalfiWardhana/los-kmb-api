...
type Repository interface {
	...
	GetMappingLtvOvd(branchId string, customerStatus string, bpkb int, resultPefindo string, tenor int, ageVehicle string, ltv float64, bakiDebet float64) (data entity.ResultElaborate, err error)
}
