...
func (_m *Repository) SaveTrxLockSystem(trxLockSystem entity.TrxLockSystem) (time.Time, error) {
	...
	var r0 time.Time
	var r1 error
	if rf, ok := ret.Get(0).(func(entity.TrxLockSystem) (time.Time, error)); ok {
		return rf(trxLockSystem)
	}
	if rf, ok := ret.Get(0).(func(entity.TrxLockSystem) time.Time); ok {
		r0 = rf(trxLockSystem)
	} else {
		r0 = ret.Get(0).(time.Time)
	}

	if rf, ok := ret.Get(1).(func(entity.TrxLockSystem) error); ok {
		r1 = rf(trxLockSystem)
	} else {
		r1 = ret.Error(1)
	}
