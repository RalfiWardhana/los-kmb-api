...
// ProcessTransaction provides a mock function with given fields: trxCaDecision, trxHistoryApproval, trxStatus, trxDetail, isCancel
func (_m *Repository) ProcessTransaction(trxCaDecision entity.TrxCaDecision, trxHistoryApproval entity.TrxHistoryApprovalScheme, trxStatus entity.TrxStatus, trxDetail entity.TrxDetail, isCancel bool) error {
	ret := _m.Called(trxCaDecision, trxHistoryApproval, trxStatus, trxDetail, isCancel)

	var r0 error
	if rf, ok := ret.Get(0).(func(entity.TrxCaDecision, entity.TrxHistoryApprovalScheme, entity.TrxStatus, entity.TrxDetail, bool) error); ok {
		r0 = rf(trxCaDecision, trxHistoryApproval, trxStatus, trxDetail, isCancel)
	} else {
		r0 = ret.Error(0)
	}
