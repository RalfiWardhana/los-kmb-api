...
type PefindoResult struct {
	...
	MaxOverdueAgunan12MonthsKORules    interface{} `json:"max_ovd_agunan_12month_ko_rules"`
	MaxOverdueNonAgunan12MonthsKORules interface{} `json:"max_ovd_non_agunan_12month_ko_rules"`
}
