...
func OpenNewKmb() (*gorm.DB, error) {

	user, pwd, host, port, database := config.GetNewKmbDB()
	...
	maxIdle, _ := strconv.Atoi(os.Getenv("NEW_KMB_DB_MAX_IDLE_CONNECTION"))
	maxOpen, _ := strconv.Atoi(os.Getenv("NEW_KMB_DB_MAX_OPEN_CONNECTION"))
